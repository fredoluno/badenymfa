...
export default function 021Sun(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 483.512 483.512" style={{enableBackground: 'new 0 0 483.512 483.512'}} xmlSpace="preserve" width="483.512" height="483.512" {...props}>
