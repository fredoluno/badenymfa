...
export default function 021Cloudy1(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 481.306 481.306" style={{enableBackground: 'new 0 0 481.306 481.306'}} xmlSpace="preserve" width="481.306" height="481.306" {...props}>
      <g>
